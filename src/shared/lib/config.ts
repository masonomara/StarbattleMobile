...
export const POWERSYNC_URL =
  ...
  (() => {
    throw new Error('Missing env var: POWERSYNC_URL');
  })();
export const ADAPTY_SDK_KEY =
  process.env.ADAPTY_SDK_KEY ??
  (() => {
    throw new Error('Missing env var: ADAPTY_SDK_KEY');
  })();
export const GOOGLE_WEB_CLIENT_ID =
  process.env.GOOGLE_WEB_CLIENT_ID ??
  (() => {
    throw new Error('Missing env var: GOOGLE_WEB_CLIENT_ID');
  })();
